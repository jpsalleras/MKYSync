    ...
    public partial class InitialSqlServer : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClienteAmbientes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClienteAmbientes_Clientes_ClienteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjetosCustom", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObjetosCustom_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClienteId = table.Column<int>(type: "int", nullable: false),
                    AmbienteOrigen = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    AmbienteDestino = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    NombreObjeto = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    TipoObjeto = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    AccionRealizada = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ScriptEjecutado = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefinicionAnterior = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SyncHistory_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClienteAmbientes_ClienteId_Ambiente",
                table: "ClienteAmbientes",
                columns: new[] { "ClienteId", "Ambiente" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjetosCustom_ClienteId_NombreObjeto_TipoObjeto",
                table: "ObjetosCustom",
                columns: new[] { "ClienteId", "NombreObjeto", "TipoObjeto" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SyncHistory_ClienteId",
                table: "SyncHistory",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_SyncHistory_FechaEjecucion",
                table: "SyncHistory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsuarioClientes_UserId_ClienteId",
                table: "UsuarioClientes",
                columns: new[] { "UserId", "ClienteId" },
                unique: true);
        }
